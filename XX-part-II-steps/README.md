...
- Клонируем наш сервис локально (обратите внимание, прежде чем выполнить комманду вам необходимо заменить имя пользователя, которое у вас используется Github)
  ```sh
