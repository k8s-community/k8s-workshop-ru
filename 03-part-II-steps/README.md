...
## Step 2 - Интеграция с Kubernetes и Github
...
## Step 4 - Знакомство с Helm и шаблонами charts 

- TODO: Знакомство с Helm (Описание, какая роль в нашем мастер-класс, примеры использования)

- TODO: Описание шаблонов charts, примеры использования
...
- Сохраним изменения в бранче `develop`
  ```sh
